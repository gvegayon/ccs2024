---
title: "epiworld"
subtitle: "A fast multi-language library for epi ABMs<br><br>Software and Data for Complex Systems<br><br>Conference on Complex Systems 2024<br>Exeter, UK"
format:
  revealjs:
    slide-number: true
...
- Existing packages: [epiworldR](https://cran.r-project.org/package=epiworldR) (on CRAN), [epiworldRShiny](https://cran.r-project.org/package=epiworldRShiny), [epiworldpy](https://github.com/UofUEpiBio/epiworldpy) (on CRAN), and [epiworldweb](https://github.com/UofUEpiBio/epiworldweb) (the last two under development).
